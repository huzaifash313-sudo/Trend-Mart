      ...
      {loading && initialSeo ? (
        <div className="space-y-4">
          <ShopMediaHeader
            ...
            logoUrl={initialSeo.logo_url}
            location={initialSeo.location}
            category={initialSeo.category}
            size="hero"
...
export default function ShopPageClient({
  ...
  return (
    ...
    >
      <ShopDetailInner id={id} initialSeo={initialSeo} />
    </ErrorBoundary>
  );
}
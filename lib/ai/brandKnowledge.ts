...
export const BRAND_KNOWLEDGE: BrandKnowledgeEntry[] = [
  {
    priority: 100,
    keys: [
      "owner", "founder", "ceo", "malik", "maalik",
      "banaya", "banane wala", "banane wale",
      "kis ne banaya", "kisne banaya", "kisne bnaya",
      "who made", "who created", "who owns", "who built", "who is owner",
      "huzaifa",
      "creator", "developer", "made by", "built by",
      "trendsmart ka owner", "trendsmart ka malik", "trends mart owner",
      "app ka owner", "app kis ki", "app kisne", "platform owner",
      // Punjabi
      "kis ne banaya", "kis ne bnaya", "kisne banaia",
      "app da malik", "app kise di", "app kine banai",
      // Hindi
      "kisne banaya", "app ka malik kaun", "company ka owner",
      "platform kisne", "ye app kisne",
    ],
  ...
  },
  {
    ...
    a:
      ...
      `• Email verify ke baad store live hota hai (admin approval queue currently off)\n` +

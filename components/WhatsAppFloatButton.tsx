...
interface WhatsAppFloatButtonProps {
  phone: string;
  shopName?: string;
  /** Shop pages: keep left so TrendBot (right) never stacks on top. */
  side?: "left" | "right";
}

/* -------------------------------------------------------------------------- */
/*  TrendsMart — Dynamic Invoice & Financial Statement Service (Prompt 3)       */
/*                                                                             */
...
export async function prepareInvoiceFromOrder(
  ...
  try {
    ...
    const merchant = {
      name: shopOverrides?.name ?? (shop as { name?: string } | null)?.name ?? "TrendsMart Merchant",
...
<body>
  <div class="invoice-wrapper">
    ...
    <div class="invoice-footer">
      ${notesHtml}
      <p>Generated by <strong>TrendsMart</strong> &mdash; ${invoice.invoiceDate}</p>
    </div>
  </div>
</body>
</html>`;
...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p>Generated by <strong>TrendsMart</strong> &mdash; ${new Date().toISOString().slice(0, 10)}</p>
    </div>
  </div>
</body>
</html>`;
...
export function generateInvoicePDF(invoice: InvoiceData): jsPDF {
  ...
  const footerLines = [
    ...
    `Generated by TrendsMart — ${invoice.invoiceDate}`,
  ];
...
export function generateSalesSummaryPDF(summary: SalesSummary, shopName: string): jsPDF {
  ...
  doc.setFontSize(7);
  doc.setTextColor(156, 163, 175);
  doc.text(`Generated by TrendsMart — ${new Date().toISOString().slice(0, 10)}`, pageWidth / 2, y, { align: "center" });
